...
タイトルは、 **“Autonomous Ground Navigation in Highly Constrained Spaces: Lessons Learned From the Benchmark Autonomous Robot Navigation Challenge at ICRA 2022”**。 competition や lessons learned の色が強いで
すが、 **狭路・高難度経路の現実感**を整理する資料として価値があります。
