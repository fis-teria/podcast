...
**B**：
タイトルは、 **“Empowering Safer Socially Sensitive Autonomous Vehicles Using Human-Plausible Cognitive Encoding”**。 social concern と human-plausible cognitive encoding を使って、 **複数 road users の影響をまとめて扱う意思決定**を提案する論文です。
**A**：
...
**B**：
さらに、 vulnerable road users については **22.9% の減少**、 accidents においては、 self-protection を **8.3%**、 all road users の protection を **17.6%**、 vulnerable road users の protection を **51.7%** 改善したと報告しています。
**A**：
