...
タイトルは、 **“INTERACTION Dataset: An INTERnational, Adversarial and Cooperative Motion Dataset in Interactive Driving Scenarios with Semantic Maps”**。 motion prediction、 planning、 behavior modeling のた
めに、 **相互作用の強い運転シナリオ**を集めた dataset 論文です。
